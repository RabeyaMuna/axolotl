"""Patch module for TiledMLP to support sequence parallelism.

This module patches the MLP forward pass to use DeepSpeed's TiledMLP
for efficient sequence parallel computation across distributed trainers.
"""
